        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InteractionTypes_AspNetUsers_MyUserId",
                        column: x => x.MyUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FollowingsId = table.Column<string>(type: "varchar(255)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyUserMyUser", x => new { x.FollowersId, x.FollowingsId });
                    table.ForeignKey(
                        name: "FK_MyUserMyUser_AspNetUsers_FollowersId",
                        column: x => x.FollowersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MyUserMyUser_AspNetUsers_FollowingsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_AspNetUsers_MyUserId",
                        column: x => x.MyUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tags_AspNetUsers_MyUserId",
                        column: x => x.MyUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Interactions_AspNetUsers_MyUserId",
                        column: x => x.MyUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Photos_AspNetUsers_MyUserId",
                        column: x => x.MyUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 7, 19, 13, 56, 24, 491, DateTimeKind.Utc).AddTicks(1136), null, "Like" },
                    { 2, new DateTime(2024, 7, 19, 13, 56, 24, 491, DateTimeKind.Utc).AddTicks(1138), null, "Share" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interactions_MyUserId_PostId_InteractionTypeId",
                table: "Interactions",
                columns: new[] { "MyUserId", "PostId", "InteractionTypeId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InteractionTypes_MyUserId",
                table: "InteractionTypes",
                column: "MyUserId");

            migrationBuilder.CreateIndex(
                name: "IX_InteractionTypes_Name",
                table: "InteractionTypes",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MyUserMyUser_FollowingsId",
                table: "MyUserMyUser",
                column: "FollowingsId");

            migrationBuilder.CreateIndex(
                name: "IX_Photos_MyUserId",
                table: "Photos",
                column: "MyUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Photos_PhotoPath",
                table: "Photos",
                column: "PhotoPath",
                unique: true);
