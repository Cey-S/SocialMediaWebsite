    ...
    public partial class initDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 7, 3, 19, 34, 29, 311, DateTimeKind.Utc).AddTicks(3358), "Like" },
                    { 2, new DateTime(2024, 7, 3, 19, 34, 29, 311, DateTimeKind.Utc).AddTicks(3359), "Share" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interactions_UserId_PostId_InteractionTypeId",
                table: "Interactions",
                columns: new[] { "UserId", "PostId", "InteractionTypeId" },
                unique: true);
